...
slug: twilio-launches-roll-your-own-google-voice
date: 2010-06-15 20:12:48 -0500
category: 
external-url: https://gigaom.com/2010/06/15/openvbx/
hash: e479a295e39207176372b9349b13fae5
year: 2010
month: 06
scheme: https
host: gigaom.com
...
Such simplification of VoIP-based services is a larger trend, other examples of which include Calliflower, a mobile-centric conference calling service. Earlier this month, Voxeos Tropo introduced OpenVoice, a virtual number application that can forward calls, handle voice mails (with transcriptions), send and receive SMS and make outbound calls.


OpenVBX is targeted at small- and medium-sized businesses.  Its multi-user, theres an easy drag n drop UI for building business applications, and a voicemail and SMS interface for managing communications. Says the company:
...
So whats in it for Twilio? Well, the system uses the underlying Twilio infrastructure, which means users buy phone numbers and connectivity from the company. Im still playing around with a demo version Twilio shared with us  Ill update the post when Im done.
