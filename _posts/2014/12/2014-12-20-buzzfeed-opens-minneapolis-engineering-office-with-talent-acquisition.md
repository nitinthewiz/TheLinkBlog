...
BuzzFeed announced today the talent acquisition of Minneapolis-based mobile and web applications development company, Hyper IQ. Joining to grow mobile technology at BuzzFeed, the Hyper IQ team will be the first employees in the new Minneapolis office focused on engineering. Hyper IQ’s team of 7 employees including President Phil Wilson will recruit and expand the team to 30 engineers working on iOS, Android, full stack, front end, and QA. 
